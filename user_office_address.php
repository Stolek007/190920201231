                        ...
                        <div class="uofb cf">
                            <div class="l_col adrs">
                                ...
                                <form action="/php/add_address.php" method="post">
                                    <div class="field">
                                        <label>Name *</label>
                                        <input type="text" value="" palceholder="" class="vl_empty" name="user_name"/>
                                    </div>
                                    <div class="field">
                                    ...
                                    <div class="field">
                                        <label>Street</label>
                                        <input type="text" value="" palceholder="" class="vl_empty" name="user_street"/>
                                    </div>
                                    <div class="field">
                                        <label>House # </label>
                            ...
                            <div class="r_col">
                                ...
                                <div class="uo_adr_list">
                                    <?php $result = $mysql->prepare("SELECT * FROM `addresses` ORDER BY `name`");
                                    $result->execute();
